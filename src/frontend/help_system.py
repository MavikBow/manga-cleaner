...
class HelpSystem(QDialog):
    def __init__(self, parent=None):
        ...
        tab1.setHtml(
            ...
            "<tr><td><b>[B] / [E] / [M]</b></td><td>Brush / Eraser / Move Tools</td></tr>"
            "<tr><td><b>[R] / [L] / [P]</b></td><td>Rect / Lasso / Poly Tools</td></tr>"
            "<tr><td><b>[G]</b></td><td>Bucket Fill Tool (Analyzes mask layer)</td></tr>"
            "<tr><td><b>[Shift] + Click</b></td><td>Draw straight line between points</td></tr>"
            "<tr><td><b>Double-Click</b></td><td>Commit Polygonal Selection</td></tr>"
            "<tr><td><b>Alt + Right-Click Drag</b></td><td><b>Dynamically Resize Brush</b> (Left: Smaller, Right: Bigger)</td></tr>"
            "<tr><td><b>Hold [Alt]</b></td><td><b>Erase Mode</b> (Quick-toggle for Brush, Rect, Lasso, Poly, Bucket)</td></tr>"
